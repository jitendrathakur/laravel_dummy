...
return array(
  ...
  /* 
   * Using webcap bundle to generate PDF, report, etc.
   * This bundle use PhantomJS as a capture-engine (this is a great tools)
   */      
  'htmlexport' => array('auto' => true),
  /*
   * I'm using the bootstrap bundle for laravel created by patrick Talmadge.
   * It is very usefull bundle to print tables etc.
   */
  'bootstrapper' => array('auto' => true),
  /*
   * This bundle will allow you to resize an uploaded image or any image 
   * from the file system with ease. Supported image types are: JPG/JPEG, PNG, GIF.
   */
  'resizer' => array( 'auto' => true ),
  /*
   * A Laravel Swift Mailer bundle, by Taylor Otwell
   */
  'swiftmailer' => array('auto'=>true),
  /*
   * A Laravel composer setup
   */
  'composer' => array('auto' => true),

   /*
   * A Laravel html to pdf setup
   */
  'laravel-html2pdf' => array('auto' => true),
