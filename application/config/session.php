 ...
 * mpeguero comments:  
 *
 * I have installed apc by running the following command: yum --enablerepo=remi install php-pecl-apc
 * Then set it up by enable it in /etc/php.d/apc.ini and /etc/php-zts.d/apc.ini... then restart se server: service php-fpm restart and service nginx restart
 *
 * There also a command for mencache: yum --enablerepo=remi install php-pecl-memcache
 *
 */
